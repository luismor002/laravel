<div class="w-full max-w-xs">
    ...
    <div class="mb-4">
      ...
      id="titulo" name="titulo" type="text" placeholder="Username">
    </div>
    <div class="mb-6">
      ...
      <input class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3
       ...
       id="imagen" name="imagen" type="text" placeholder="imagen">
    ...
    <div class="mb-6">
      ...
      <input class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3
       text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
        id="descripcion" name="descripcion" type="text" placeholder="descripcion">
